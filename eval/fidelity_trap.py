...
ürün tamamen offline, bkz. AGENTS.md §1.2) `grounded` işaretlenir.
...
DİKKAT (AGENTS.md §1.4): bu script'in FAIL dönmesi FIDELITY_MIN_SCORE'u
...
def main(argv=None) -> int:
    ...
    print(
        ...
        "değiştirme gerekçesi DEĞİL (AGENTS.md §1.4, §9.6 -- alternatif zaten "
